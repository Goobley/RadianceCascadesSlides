...
<!-- TODO
- Some other complex atmospheres, muram, bifrost
- ionisation
- add logos
- Concluding remarks -->
...
::: {.fragment .current-visible}
![](static_assets/PenumbraCriterionFrame.png){style="max-width: 80%;"}

[TODO: Get some more things]{.attrib}
:::
...
- Viable route to non-LTE RMHD in realistic _complex_ models.
