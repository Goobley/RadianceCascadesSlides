...
- By interpolation we construct $\mathcal{R}_{t_{i+1},t_{i+2}}(\vec{p},\hat{\omega})$ for each probe of cascade $i$ ($[t_i, t_{i+1}]$).
...
Linear scaling in compute, [exponential]{.fragment .red-shift} scaling in constructed rays!
:::
